...
Ver guía: INICIO_RAPIDO_CALENDLY.md

Configuración Completa
Ver guía detallada: GUIA_COMPLETA_CALENDLY.md
...
Crear un evento (ej: "Consulta Legal - 30 min")
Copiar la URL del evento
...
Configurar permisos para Teams API
Actualizar variables en .env
Pasarela de Pago
Configurar con tu proveedor de pagos
Actualizar variables en .env
Implementar lógica de procesamiento en routes/payments.js
Cumplimiento RGPD
El sistema incluye:
